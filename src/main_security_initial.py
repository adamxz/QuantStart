# -*- coding: utf-8 -*-
"""
Created on Tue Nov 29 11:28:27 2016
    ...
    if state_public_tmp:
        ...
        for content in content_all:
            if content.string == 'A股代码':
                id_security = content.find_next_sibling().string
...
if __name__ == "__main__":
    ...
    file_csv = open(file_url, 'a',encoding = 'utf-8')
    ...
    prefix_max = [1999, 999, 999, 0, 0, 776, 999]
    '''prefix_str = ['sz', 'sz', 'sz', 'sz', 'sz']
      prefix_ini = [0, 1696, 1896, 2000, 300000]
      prefix_max = [999, 0, 0, 776, 999]'''
    ...
    try:
        file_csv = open(conf.csv_url,'r',encoding='utf-8')
        ...
        insert_columns = conf.column_str
        table_name = 'data_security'
        for row in f_csv:
        #insert_query = tuple(row)
            insert_values = str(row)[1:-1]
            data_engine.insert(table_name, insert_columns, insert_values)
